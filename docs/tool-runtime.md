...
- **`backend/api/routes/_wf_actions.py:129`** 的 ripple-retry 路由仍直调
...
| `ripple_service_direct_call_sites_in_api_routes` | `2` | 正则：这几个文件里 `ripple.submit_and_wait(` 的出现次数（`backend/api/routes/_wf_actions.py:129` 与 `:147`） |
