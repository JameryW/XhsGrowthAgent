...
const variantClasses = computed(() => {
  const variants = {
    ...
    ghost: 'dark-explicit bg-white/80 border-gray-200 text-slate-700 hover:bg-white hover:border-gray-300 hover:scale-[1.02] dark:bg-slate-900/70 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:border-slate-500',
  }
