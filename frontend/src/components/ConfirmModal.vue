        ...
        <div class="relative w-full max-w-md p-6 rounded-2xl liquid-glass-elevated">
          ...
          <div class="flex gap-3 justify-end">
            <button
              ref="cancelButtonRef"
              type="button"
              class="dark-explicit min-h-11 px-4 py-2.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-600 hover:bg-slate-100 transition-all dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
              @click="handleCancel"
            >
              {{ displayCancelLabel }}
            </button>
