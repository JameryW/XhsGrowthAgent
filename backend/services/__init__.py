...
# Lazy re-exports — importing omp_bridge / ripple_service eagerly at package
# load costs ~0.37s (httpx, langchain chain) on every app cold start.
# RippleService is constructed in the app lifespan; the others are used at
# request time. Resolved on first attribute access, cached in globals.
